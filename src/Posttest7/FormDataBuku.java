...
public class FormDataBuku extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            String sql = "select*from buku where judul='"+jTextField1.getText()+"' and penulis='"+jComboBox1.getSelectedItem()+"'";
            stt = con.createStatement();
            rss = stt.executeQuery(sql);
            if(rss.next()){                             //jika data yang akan dimasukkan dalam databases selanjutnya sudah ada
                Object[] o=new Object[4];               //dengan menampilkan 4 objek 
                    o[0] = rss.getString ("id");
                    o[1] = rss.getString("judul");
                    o[2] = rss.getString("penulis");
                    o[3] = rss.getString("harga");
                    model.addRow(o);                      //maka data tersebut tidak masuk dalam tabel
                JOptionPane.showMessageDialog(null,"Data Sudah Pernah Ada"); // dan menampilkan pesan data sudah ada
            }else{                                          //kalau tidak ada maka
                TambahData(judul, penulis, harga);          // tambah data dilakukan untuk judul, penulis dan harga
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int baris = jTable1.getSelectedRow();       //digunakan untuk mengambil baris pada tabel
        
        jTable1.setValueAt(jTextField1.getText(), baris, 1);        //mengeset tabel dengan mengambil text pada kolom judul baris pertama
        jTable1.setValueAt(jComboBox1.getSelectedItem(), baris, 2);
        jTable1.setValueAt(jTextField2.getText(), baris, 3);
        
        String id = jTable1.getValueAt(baris, 0).toString();        //mengambil nilai pada baris pertama dari id
        ...
        try {
            ...
            stt = con.createStatement();
            rss = stt.executeQuery(sql);
            if(rss.next()){                         //jika data selanjutnya yang akan dimasukkan dalam database sudah ada
                Object[] o = new Object[4];         //seperti 4 object yang akan diambil yaitu id, judul, penulis dan hargs
                    o [0] = rss.getString("ID");
                    o [1] = rss.getString("JUDUL");
                    o [2] = rss.getString("PENULIS");
                    o [3] = rss.getInt("HARGA");
                    model.addRow(o);
                    JOptionPane.showMessageDialog(null, "Data Sudah Pernah Ada");
                    InitTable();
                    TampilData();
            }else{
